...
export default function Home() {
    ...
    useEffect(() => {
        async function getGenre() {
            try {
                const response = await fetch(`https://gamescript-pi.vercel.app/genre/${params.slug}`,
                {
                    method: 'GET'
                });
    ...
    useEffect(() => {
        async function getGenreGames() {
            try {
                const response = await fetch(`https://gamescript-pi.vercel.app/gamesByGenre/${genre._id}/page/${params.number}`,
                {
                    method: 'GET'
                });

    ...
    const GetPages = () => {
        if (games !== null && games.games.length > 0) {
            ...
            selector.push(
                ...
                href={`/genres/${params.slug}/page/${1}`} as={`/genres/${params.slug}/page/${1}`}>
            ...
            for (let i=0; i<numPages; i++) {
                selector.push(
                    ...
                    style={{display: i >= actualPage-1 && i <= actualPage+1 ? 'block' : 'none'}} href={`/genres/${params.slug}/page/${i+1}`} as={`/genres/${params.slug}/page/${i+1}`}>
                        {i+1}
                    </Link>
                )
            }
            selector.push(
                ...
                href={`/genres/${params.slug}/page/${numPages}`} as={`/genres/${params.slug}/page/${numPages}`}>
                    <div className={styles['go-to-container']}>

          ...
          async function getScreenshots() {
            ...
            try {
                for (let game of randomGames) {
                    ...
                    screenshots.push(<Image loading="lazy" key={image.image_id} src={`https://images.igdb.com/igdb/image/upload/t_screenshot_med_2x/${image.image_id}.jpg`} fill sizes="100%" alt="screenshot.jpg" priority/>);
                }

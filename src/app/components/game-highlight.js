                ...
                <>
                    ...
                    <div className="w-full absolute top-16 flex flex-col justify-end h-[calc(min(100vw_*_9_/_16,_100vh)_-_4rem)] z-30">
                        <div className="w-full h-1/2 flex justify-between items-end px-9">
                            <button className="text-[#fff8] text-4xl" onClick={() => setActiveGame(activeGame > 0 ? activeGame-1 : randomGames.length-1)}>
                                <FaChevronLeft />
                            </button>
                            <button className="text-[#fff8] text-4xl" onClick={() => setActiveGame(activeGame < randomGames.length - 1 ? activeGame + 1 : 0)}>
                                <FaChevronRight />
                            </button>
                        </div>

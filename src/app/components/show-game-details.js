...
export default function ShowGameDetails({game, setShowGameDetails}){
    ...
    useEffect(() => {
        async function getGameLanguages() {
            try {
                const response = await fetch(`https://gamescript-pi.vercel.app/languagesByGameId/${game._id}`,
                {
                    method: 'GET'
                });
        ...
        async function getGameGenres() {
            ...
            for (let g of game.genres) {
                try {
                    const response = await fetch(`https://gamescript-pi.vercel.app/genre/${g}`,
                    {
                        method: 'GET'
                    });
                    const json = await response.json();
        ...
        async function getGameThemes() {
            ...
            for (let t of game.themes) {
                try {
                    const response = await fetch(`https://gamescript-pi.vercel.app/theme/${t}`,
                    {
                        method: 'GET'
                    });
                    const json = await response.json();
        ...
        async function getScreenshots() {
          ...
          try {
              for (let screenshot of game.screenshots) {
                const response = await fetch(`https://gamescript-pi.vercel.app/screenshot/${screenshot}`, 
                {
                    method: 'GET',
                });

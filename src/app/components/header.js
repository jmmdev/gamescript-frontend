...
export default function Header({isDynamic}) {
    ...
    const GetSideMenu = () => {
        return (
            <div className={`fixed top-0 w-full -left-full h-screen md:w-[250px] md:-left-[250px] ${showMenu ? "translate-x-full" : "translate-x-0"} transition-all duration-200 ease-linear bg-gray-800 z-20 flex flex-col justify-between items-center gap-4 p-3`}>

...
export default function Header({isDynamic}) {
    ...
    */
    ...
    const GetSideMenu = () => {
        if (showMenu) {
            return (
                <div className="fixed top-0 w-full h-screen md:left-[-250px] md:animate-slide md:w-[250px] bg-gray-800 z-50 flex flex-col justify-between items-center gap-4 p-3">

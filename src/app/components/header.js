...
export default function Header({isDynamic}) {
    ...
    */
    ...
    const GetSideMenu = () => {
        return (
            <div className={`fixed top-0 w-full h-screen ${showMenu ? "md:w-[250px] p-3" : "md:w-0"} ease-in-out bg-gray-800 z-50 flex flex-col justify-between items-center gap-4 overflow-hidden`}>
